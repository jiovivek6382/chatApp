            ...
            firebase.database().ref('fcmTokens').child(friend_id).once('value').then(function (data) {
                $.ajax({
                    ...
                    headers: {
                        ...
                        'Authorization': 'key=AIzaSyAkO_mHJycML7pInHOy089zWrg59V152A0'
                    },
                    data: JSON.stringify({
...
function onStateChanged(user) {
    if (user) {
        ...
        db.on('value', function (users) {
            ...
            navigator.serviceWorker.register('https://jiovivek6382.github.io/chatApp/messaging/firebase-messaging-sw.js')
                .then((registration) => {
